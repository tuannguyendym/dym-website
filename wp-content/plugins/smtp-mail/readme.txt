...
Tags: smtp, mail, phpmailer, send test, smtp setting
...
[Documentation](http://dev.moivui.com/smtp-mail/)

= Our Free Plugins: =   

- [Photo Box](https://wordpress.org/plugins/photo-box) 
- [Adsense Code](https://wordpress.org/plugins/photoboxone-adsense-code)
- [Breadcrumb Box](https://wordpress.org/plugins/breadcrumb-box)
- [List Posts](https://wordpress.org/plugins/list-post-one)
...
You can help translate `SMTP Mail` plugin on [translate.wordpress.org](https://translate.wordpress.org/projects/wp-plugins/smtp-mail).

== Screenshots ==

1. SMTP Mail - Setting. 
2. SMTP Mail - Send test.
3. SMTP Mail - Submit data - list.
...
= 1.2 =
* Fixed Reflected Cross-Site Scripting issue.
